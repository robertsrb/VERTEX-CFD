#ifndef VERTEXCFD_TEMPUSOBSERVER_WRITETOEXODUS_HPP
...
class WriteToExodus : virtual public Tempus::IntegratorObserver<Scalar>
{
  public:
    WriteToExodus(const Teuchos::RCP<Mesh::ExodusWriter>& exodus_writer,
  ...
  private:
    Teuchos::RCP<Mesh::ExodusWriter> _exodus_writer;
    int _write_frequency;
    int _last_index = -1;
};
...
#include "VertexCFD_TempusObserver_WriteToExodus_impl.hpp"

#endif // end VERTEXCFD_TEMPUSOBSERVER_WRITETOEXODUS_HPP
