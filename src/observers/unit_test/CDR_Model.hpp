...
// ****************************************************************************
// Adapted for use in VertexCFD from Trilinos/packages/tempus/test/TestModels
// ****************************************************************************

#ifndef VERTEXCFD_CDR_MODEL_HPP
#define VERTEXCFD_CDR_MODEL_HPP
 ...
 */
template<class Scalar>
class CDR_Model final : public ::Thyra::StateFuncModelEvaluatorBase<Scalar>
{
  public:
    ...
    create_W_prec() const override;
    //@}

  private:
    /** Allocates and returns the Jacobian matrix graph */
    Teuchos::RCP<Epetra_CrsGraph> createGraph();
