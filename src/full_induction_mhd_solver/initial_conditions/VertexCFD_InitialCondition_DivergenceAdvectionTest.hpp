#ifndef VERTEXCFD_INITIALCONDITION_DIVERGENCEADVECTIONTEST_HPP
...
class DivergenceAdvectionTest : public panzer::EvaluatorWithBaseImpl<Traits>,
                                public PHX::EvaluatorDerived<EvalType, Traits>
{
  public:
    ...
    DivergenceAdvectionTest(const Teuchos::ParameterList& params,
  ...
  private:
    ...
    double _phi;
    double _r0;
    Kokkos::Array<double, 3> _xy_0;
    Kokkos::Array<double, 3> _vel;
};
...
#include "VertexCFD_InitialCondition_DivergenceAdvectionTest_impl.hpp"

#endif // end VERTEXCFD_INITIALCONDITION_DIVERGENCEADVECTIONTEST_HPP
