#ifndef VERTEXCFD_INITIALCONDITION_STEP_HPP
#define VERTEXCFD_INITIALCONDITION_STEP_HPP
...
class Step : public panzer::EvaluatorWithBaseImpl<Traits>,
             public PHX::EvaluatorDerived<EvalType, Traits>
{
  public:
    ...
    Step(const Teuchos::ParameterList& params, const panzer::PureBasis& basis);
  ...
  private:
    ...
    scalar_type _left_value, _right_value, _origin;
    int _basis_index;
...
#endif // end VERTEXCFD_INITIALCONDITION_STEP_HPP
